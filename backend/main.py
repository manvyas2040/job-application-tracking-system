...
def register(payload: UserCreate, db: Session = Depends(get_db)):
    ...
    message = "Bootstrap admin created and activated" if is_first_admin else "Account created and pending activation"
    return {"user_id": user.user_id, "status": user.status, "message": message}
