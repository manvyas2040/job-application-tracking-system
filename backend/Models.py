...
#  Relationships
    ...
    interview = relationship("interview",back_populates="interviewer")
    feedback = relationship("interviewfeedback",back_populates="interview")
    audit_logs = relationship("AuditLog",back_populates="user")
    notifications = relationship("CandidateNotification",back_populates="candidate")
...
class Job(Base):
    ...
    job_status = Column(String,default="open")
...
#  # Relationships
    ...
    candidate = relationship("User",back_populates="notifications")
